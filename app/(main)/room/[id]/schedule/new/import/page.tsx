...
export default function ImportSchedulePage() {
  ...
  const handleApplyClick = async () => {
    ...
    if (currentSchedule.is_finalized) {
      showAlert("이미 확정된 스케줄에는 복사할 수 없습니다.");
      return;
    }
    ...
    try {
      ...
      showAlert("이전 스케줄을 이번 주로 복사했습니다!");
      ...
      <div className="p-4">
        ...
        <div className="mt-4">
          <Button
            ...
            className="fixed bottom-22 left-2 w-94"
          >
  ...
  return (
    <div className="p-4">
      <h1 className="text-xl text-gray-900 mb-6">이전 스케줄 불러오기</h1>
        ...
        {historyList.length > 0 ? (
          historyList.map((item) => (
            <Link
              ...
              className="py-4 border-b border-main-purple text-md"
            >
